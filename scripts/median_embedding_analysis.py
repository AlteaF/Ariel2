...
def analyze_embeddings_and_save_csv(npz_path, out_csv_path='median_classification_summary_dino_norm.csv',
...
def plot_pretty_confusion_matrices(df):
    ...
    plt.title("Heat map of DINOv2 embeddings normalised \n median analysis", fontsize=16)
    plt.xlabel("Predicted Class", fontsize=14)
    plt.ylabel("True Class", fontsize=14)
    plt.tight_layout()
    plt.savefig("../analysis_of_embedding_distance/test_on_clean_emb.pdf")
    plt.show()
    ...
    plt.title("Heat map (row normalised) of DINOv2 embeddings normalised\n median analysis", fontsize=16)
    plt.xlabel("Predicted Class", fontsize=14)
    plt.ylabel("True Class", fontsize=14)
    plt.tight_layout()
    plt.savefig("../analysis_of_embedding_distance/test_on_clean_emb_norm.pdf")
    plt.show()



# Example usage:
df = analyze_embeddings_and_save_csv('../embeddings_filtered/dino_embeddings_norm_median.npz',
                                    out_csv_path='../analysis_of_embedding_distance/median_classification_summary_on_cleaned_emb_dino_norm.csv',
                                    tie_atol=1e-8,
